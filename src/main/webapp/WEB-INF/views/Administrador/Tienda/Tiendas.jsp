...
<!-- Left Panel -->
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">TIENDAS</strong>
                        </div>
                           ...
                           <div class="row">
                              <div class="col text-right">
                                  ...
                                  <button class=" btn btn-secondary"   data-toggle="modal" data-target="#largeModal">CREAR NUEVO TIENDA</button>
                    ...
                    <tbody>
                    	<c:forEach var="tienda" items="${tiendas}">
		                      <tr>
		                        ...
		                        <td>${tienda.nombreRepresentante}</td>
	...
	<%@ include file="RegistrarTienda.jsp" %>
