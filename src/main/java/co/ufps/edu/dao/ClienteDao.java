...
public class ClienteDao {
  ...
  public List<Cliente> getClientes() {
    ...
    SqlRowSet sqlRowSet =
        springDbMgr.executeQuery("select 		cliente.codigo			 codigoCliente, "
            + " 	   		cliente.tipoDoc 		 doc, "
            + "			cliente.numeroDocumento  num, "
            + " 			cliente.nombre			 nom, "
            + "			cliente.apellido         apellido, "
            + "			cliente.direccion	     direccion " + "from 		cliente "
  ...
  public String registrarCliente(Cliente cliente) {
    ...
    // Si hubieron filas afectadas es por que si hubo registro, en caso contrario muestra el
    // mensaje.
    // de error.
  ...
  public Cliente obtenerClientePorCodigo(long codigoCliente) {
    ...
    SqlRowSet sqlRowSet =
        springDbMgr.executeQuery(" SELECT * FROM cliente WHERE codigo= :codigo", map);
